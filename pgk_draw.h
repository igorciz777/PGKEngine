...
namespace PGK_Draw
{
    ...
    inline cVec3 calculatePhongLighting(const std::shared_ptr<PGK_Light> &light, const Vec3 &lightDir, const Vec3 &viewDir, const Vec3 &reflectDir, const Vec3 &normal);
    inline cVec3 calculateBlinnPhongLighting(const std::shared_ptr<PGK_Light> &light, const Vec3 &lightDir, const Vec3 &viewDir, const Vec3 &normal);
    inline cVec3 calculateFlatLighting(const std::shared_ptr<PGK_Light> &light, const Vec3 &lightDir, const Vec3 &normal);
};
